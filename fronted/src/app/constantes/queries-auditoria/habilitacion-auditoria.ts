...
USE master
GO;
CREATE SERVER AUDIT Auditoria_BD TO FILE ( FILEPATH = 'E:\\Auditoria' )`;

export const HHABILITAR_AUDITORIA = `
USE master
GO;
...
export const log_auditoria = (prefijo: string) => {
  return `SELECT distinct fn.event_time,
	   ...
	   fn.object_name,
	   fn.statement
 FROM sys.fn_get_audit_file ('E:\\Auditoria1\\${prefijo}', DEFAULT, DEFAULT) as fn
